...
// ✅ Redirects user directly to Google, returns back to main page
...
// ✅ Login modal with redirect button
  ...
  body.innerHTML = `
      <div class="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-inner space-y-6 text-center">
          ...
          <div>
              ...
              <p class="text-gray-600">Увійдіть через свій Google акаунт, щоб приєднатися до обговорень та створювати пости у форумі.</p>
          </div>
          <div id="google-signin-container"></div>
          <div class="text-xs text-gray-500 space-y-1">
              <p>Використовуючи Google вхід, ви погоджуєтесь з нашими умовами використання.</p>
              <p>Ваші дані захищені та використовуються лише для ідентифікації у форумі.</p>
          </div>
      </div>
  `;
